...
3. [Add cloudflare original-certificate and private key to nginx](https://www.rcdevops.io/posts/Setting-Up-Cloudflare-SSL-TLS-Origin-Certificate-with-NGINX/)
...
8. [Copy directory or files from one user to another in the same machine](https://askubuntu.com/questions/551047/copying-files-from-one-user-to-another-in-a-single-machine)
